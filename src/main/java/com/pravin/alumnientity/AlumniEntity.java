...
public class AlumniEntity {
	...
	public AlumniEntity(Integer sn, String firstname, String lastname, String gender, String dob, String email,
	...
	public String toString() {
		return "AlumniEntity [Sn=" + Sn + ", firstname=" + firstname + ", lastname=" + lastname + ", gender=" + gender
